...
class CreditsState extends MusicBeatState
{
	...
	private static var creditsStuff:Array<Dynamic> = [ //Name - Icon name - Description - Link - BG Color
		...
		[''],
		['Skalloween Spectracle'],
		['Mkv8',				'Mkv8',			'Artist, Programmer and Creator of Alfie',						'https://twitter.com/Mkv8Art',			0xFFB8234D],
		['josszzol',				'josszzol',			'Artist and Creator of Filip',						'https://twitter.com/Abbledacker',			0xFFFFDE38],
		['xeltxrx',				'xeltxrx',			'Composer',						'https://twitter.com/xeltxrx',			0xFFEE99F0],
		['Meta',				'meta',			'Composer',						'https://metahumanboi.newgrounds.com/',			0xFF381066],
		['PpavlikosS',				'PpavlikosS',			'Charter',						'https://www.youtube.com/c/PpavlikosS',			0xFFB8234D],
		['ThisIsBennyK',				'benny',			'Programming help',						'https://twitter.com/ThisIsBennyK',			0xFF74B5D4],
		[''],
		["Funkin' Crew"],
